...
import com.example.llmhost.AgentToolDefinition
import com.example.llmhost.ChatSession
import com.example.llmhost.DeviceCapabilityProfile
import com.example.llmhost.GenerationSettings
import com.example.llmhost.HuggingFaceModelCatalog
import com.example.llmhost.PendingAgentToolAction
    ...
    fun restore(): Boolean {
        ...
        return try {
            ...
            if (storedChatId == chatId) {
                ...
                val definition = com.example.llmhost.AgentToolRegistry.find(toolName)
