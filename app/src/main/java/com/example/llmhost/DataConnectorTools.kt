...
class DataConnectorTools(private val context: Context) {
    ...
    fun searchContacts(query: String, maxResults: Int = 10): List<ContactResult> {
        ...
        val cursor = context.contentResolver.query(
            ...
            null,
            null,
            ContactsContract.Contacts.DISPLAY_NAME_PRIMARY + " ASC LIMIT " + maxResults.coerceIn(1, 50),
        )
        cursor?.use { c ->
    ...
    fun getCalendarEvents(
        ...
        val cursor = context.contentResolver.query(
            ...
            null,
            null,
            CalendarContract.Instances.BEGIN + " ASC LIMIT " + maxResults.coerceIn(1, 50),
        )
        cursor?.use { c ->
    ...
    fun listSmsThreads(limit: Int = 10): List<SmsThreadResult> {
        ...
        val cursor = context.contentResolver.query(
            ...
            null,
            null,
            Telephony.Sms.Conversations.DATE + " DESC LIMIT " + limit.coerceIn(1, 50),
        )
        cursor?.use { c ->
